...
import (
	...
	p2pConfig "github.com/libonomy/libonomy-p2p/p2p/config"
	"github.com/spf13/viper"
)

const (
	defaultConfigFileName  = "./config.toml"
	defaultLogFileName     = "libonomy.log"
	defaultAccountFileName = "accounts"
	defaultDataDirName     = "libonomy"
...
// DefaultBaseConfig returns a default configuration for libonomy
